    ...
    */
    ...
    function prepareTable()
    {
        ...
        if (this.options.navigation & 2)
        {
            ...
            var len = $(".fixed-table-container").length;
            if (len > 0) {
                $(".fixed-table-container").after(this.footer);
            } else {
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            body: "<tbody></tbody>",
            cell: "<td class=\"{{ctx.css}}\" style=\"{{ctx.style}}\"><div style=\"word-wrap:break-word;word-break:inherit;\">{{ctx.content}}</div></td>",
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row paggingrow\"><div class=\"col-sm-6 infoBar\"><p class=\"{{css.infos}}\"></p></div><div class=\"col-sm-6 paggingBar\"><p class=\"{{css.pagination}}\"></p></div></div></div>",
